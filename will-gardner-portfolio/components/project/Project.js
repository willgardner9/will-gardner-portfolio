...
const Project = ({
  projectNameText,
  projectDescription,
  viewLiveButtonDestination,
  viewOnGitHubButtonDestination,
  readCaseStudyDestination,
  projectImage,
}) => {
  return (
    <section className="flex flex-col w-full mt-16 mb-24">
      ...
      <div className="mt-8 flex flex-col sm:flex-row lg:justify-end">
        <GhostButton
          ...
          buttonDestination={viewLiveButtonDestination}
        />
        <GhostButton
          buttonText="View on GitHub"
          buttonDestination={viewOnGitHubButtonDestination}
        />
        <PrimaryButton
          buttonText="Demo and case study"
          buttonDestination={readCaseStudyDestination}
        />
      </div>
    </section>
  );
